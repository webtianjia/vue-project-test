<template>
  ...
  <el-breadcrumb separator="/">
    ...
    <el-breadcrumb-item :to="{ path: '/home/bookList' }">教材体系管理</el-breadcrumb-item>
  ...
  export default{
    ...
    methods: {
      ...
      async UpdatecontentReplyKejian() {
          ...
          await this.GetEvaluationsFromMaterialsSystem();
      ...
      GetEvaluationsFromMaterialsSystem(){
        let formData = {
          ...
          pageNo: this.pageNo,
          materialsSystemID: this.$route.params.materialsSystemID
        };
        this.$store.dispatch('GetEvaluationsFromMaterialsSystem', formData).then(res => {
          this.commentList = []
    ...
    mounted(){
      this.GetEvaluationsFromMaterialsSystem();
    },
    activated(){
      this.GetEvaluationsFromMaterialsSystem();
    }
